...
class Module {
 public:
  ...
  virtual void processPulse(const string& sender, bool pulse, queue<Pulse>& pulses) = 0;
...
class Button : public Module {
 public:
  ...
  void processPulse(const string& sender, bool pulse, queue<Pulse>& pulses) override {
...
void solve(){
  ...
  for_(i,0,1000) {
    ...
    while (!pulses.empty()) {
      ...
      modules[dest]->processPulse(src, state, pulses);
    }
  }
