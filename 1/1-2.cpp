...
void solve(){
  ...
  do {
    ...
    for_(i,0,n){
      ...
      else if (s.substr(i,3) == "zero") dig = 0;
      else if (s.substr(i,3) == "one") dig = 1;
      else if (s.substr(i,3) == "two") dig = 2;
      else if (s.substr(i,5) == "three") dig = 3;
      else if (s.substr(i,4) == "four") dig = 4;
      else if (s.substr(i,4) == "five") dig = 5;
      else if (s.substr(i,3) == "six") dig = 6;
      else if (s.substr(i,5) == "seven") dig = 7;
      else if (s.substr(i,5) == "eight") dig = 8;
      else if (s.substr(i,4) == "nine") dig = 9;
    ...
    for_(i,0,n){
      ...
      else if (s.substr(i,3) == "owt") dig = 2;
      else if (s.substr(i,5) == "eerht") dig = 3;
      else if (s.substr(i,4) == "ruof") dig = 4;
      else if (s.substr(i,4) == "evif") dig = 5;
      else if (s.substr(i,3) == "xis") dig = 6;
      else if (s.substr(i,5) == "neves") dig = 7;
      else if (s.substr(i,5) == "thgie") dig = 8;
      else if (s.substr(i,4) == "enin") dig = 9;
